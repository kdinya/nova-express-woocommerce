	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="nvx-grid">
		...
		<section class="nvx-card">
			...
			<label class="nvx-field">
				...
				<div class="nvx-api-key-row">
					<input type="password" id="nvx_api_key" name="api_key" value="<?php echo esc_attr( $settings['api_key'] ); ?>" autocomplete="off" placeholder="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" />
					<button type="button" class="nvx-btn nvx-btn--ghost" id="nvx-toggle-api-key">
		...
		<section class="nvx-card">
			...
			<label class="nvx-field nvx-field--checkbox" style="margin-top:12px;">
				...
				<div class="nvx-checkbox-text">
					<span class="nvx-checkbox-title"><?php esc_html_e( 'Маска та перевірка номера телефону (+380...) на чекауті', 'wc-nova-express' ); ?></span>
