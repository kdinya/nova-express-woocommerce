...
<div class="nvx-page-header">
	<h2><?php esc_html_e( 'Конструктор користувацької етикетки ТТН', 'wc-nova-express' ); ?></h2>
	<p class="nvx-page-subtitle">
		<?php esc_html_e( 'Налаштуйте розміри, склад елементів та вигляд спрощеного HTML-шаблону для друку ТТН на термопринтерах або звичайних аркушах.', 'wc-nova-express' ); ?>
	</p>
</div>

<?php if ( isset( $_GET['updated'] ) && '1' === $_GET['updated'] ) : ?>
	<div class="notice notice-success is-dismissible nvx-notice" style="margin: 15px 0 20px 0;">
		<p><strong><?php esc_html_e( 'Налаштування шаблону етикетки успішно збережено.', 'wc-nova-express' ); ?></strong></p>
	</div>
<?php endif; ?>
...
<div class="nvx-label-builder-grid">
	...
	<div class="nvx-label-builder-controls">
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="nvx-label-template-form">
			...
			<section class="nvx-card">
				<header class="nvx-card__header">
					<h3><?php esc_html_e( '2. Стиль та вирівнювання', 'wc-nova-express' ); ?></h3>
				</header>
				<div class="nvx-card__body">
					<div class="nvx-form-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
						<div class="nvx-field">
						...
						<div class="nvx-field">
							<label for="nvx_lbl_font_size"><strong><?php esc_html_e( 'Розмір шрифту:', 'wc-nova-express' ); ?></strong></label>
			...
			<div class="nvx-card__body" style="background:#f4f6f8;padding:20px;display:flex;justify-content:center;align-items:flex-start;min-height:360px;">
				<div id="nvx-label-preview-box" class="nvx-label-preview-box"
					...
					<div id="prev-barcode" style="margin:4px 0 6px 0;">
						<div style="height:38px;background:repeating-linear-gradient(90deg,#000,#000 2px,#fff 2px,#fff 4px,#000 4px,#000 7px,#fff 7px,#fff 9px);margin:0 auto;width:90%;"></div>
					</div>
